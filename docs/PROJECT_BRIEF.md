        ...
        crontab-lite exists to solve a narrow, inspectable developer-tooling problem:
        ...
        Topics: cron, crontab, parser, python, scheduler, zero-dependencies

        ## Current Gates

        - Latest completed CI: success
        - Source files counted by audit: 4
        - Test files counted by audit: 7
